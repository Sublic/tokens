...
import './SublicPlugin.sol';

/// @title Algebra Integral 1.0 default plugin factory
/// @notice This contract creates Algebra default plugins for Algebra liquidity pools
contract SublicPluginFactory is IBasePluginV1Factory {
  ...
  function _createPlugin(address pool) internal returns (address) {
    ...
    IAlgebraBasePluginV1 volatilityOracle = new SublicPlugin(pool, algebraFactory, address(this));
